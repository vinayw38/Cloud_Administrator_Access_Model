...
# TO DO: Change the code to test with list of USERS
variable "user_name" {
  type        = string
...
variable "managed_policies" {
  ...
  validation {
    condition     = !(contains(var.managed_policies, "AdministratorAccess"))
    error_message = "Administrator Access Policy is not allowed via CAAM Automation."
  }
}
